    ...
    <div style="font-family: Arial, sans-serif; border: 1px solid #ddd; padding: 20px; border-radius: 10px; max-width: 600px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
            <tr style="background-color: #f8f9fa;">
                <td style="padding: 10px; border: 1px solid #ddd;"><b>Target Weight</b></td>
                <td style="padding: 10px; border: 1px solid #ddd; color: #27ae60;">{results['prediction']['final_weight']} kg</td>
            </tr>
            <tr>
                <td style="padding: 10px; border: 1px solid #ddd;"><b>BMI Score</b></td>
                <td style="padding: 10px; border: 1px solid #ddd;">{results['prediction']['initial_bmi']}</td>
            </tr>
            <tr style="background-color: #f8f9fa;">
                <td style="padding: 10px; border: 1px solid #ddd;"><b>Muscle Growth</b></td>
                <td style="padding: 10px; border: 1px solid #ddd; color: #2980b9;">+{results['prediction']['muscle_change']}%</td>
            </tr>
        </table>

        <h3 style="color: #e67e22;">Recommended Exercises:</h3>
        <ul style="background: #fff5e6; padding: 15px; border-radius: 5px; list-style-type: none;">
            {"".join([f"<li style='margin-bottom: 10px;'>{ex}</li>" for ex in results['alternative_workouts']])}
        </ul>

        <p style="text-align: center; color: #7f8c8d; font-size: 12px; margin-top: 30px;">
            Keep pushing! Trust the process. <br> 
            <i>Sent by Gym & Meal AI Project</i>
        </p>
    </div>
    """
